...
function scrollFunction() {
   {
    ...
    document.getElementById("home").style.color = "#2081C3";
    document.getElementById("cart-icon").style.color = "#2081C3";
    document.getElementById("profile-icon").style.color = "#2081C3";
